...
export const fetchedTracksFromMusicDb = createEvent('fetchedTracksFromMusicDb', (tracks: ArrayWithTotalCount<Track>) => tracks)
export const fetchedTracksFromYouTube = createEvent('fetchedTracksFromYoutube', (tracks: Track[]) => tracks)

export const initiatedTracksNextPageFetch = createEvent('initiatedTracksNextPageFetch', (form: MusicDbTrackQueryForm) => form)
export const fetchedTracksNextPage = createEvent('fetchedTracksNextPage', (tracks: ArrayWithTotalCount<Track>) => tracks)
