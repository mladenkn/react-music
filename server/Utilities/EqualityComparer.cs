...
namespace Utilities
{
    ...
    {
        /// <summary>
        /// Creates an instance of EqualityComparer using the specified projection.
        /// </summary>
        ...
        /// <returns>A comparer which will compare elements by projecting
        /// each element to its key, and comparing keys</returns>
        public static EqualityComparer<TSource, TKey> Create<TSource, TKey>
        (TSource ignored,
    ...
    public class EqualityComparer<TSource, TKey> : IEqualityComparer<TSource>
    {
        ...
        public EqualityComparer(Func<TSource, TKey> projection)
